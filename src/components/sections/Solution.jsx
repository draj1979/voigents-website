    ...
    return (
        <section id="solution" className="section-padding" style={{ background: 'var(--bg-card)' }}>
            <div className="container">
                <div className="grid grid-2 items-center" style={{ gap: '48px' }}>
                    {/* Content */}
                    ...
                    {/* Abstract Visual */}
                    <div className="relative flex justify-center w-full-mobile">
                        ...
                        <div className="glass" style={{ padding: '8px', border: '1px solid rgba(255,255,255,0.1)', transform: 'rotate(2deg)', maxWidth: '100%' }}>
                            <div className="flex-center" style={{ background: '#080808', borderRadius: '12px', width: 'min(400px, 100%)', height: 'min(400px, 80vw)', position: 'relative', overflow: 'hidden' }}>
                                <div className="absolute pulse" style={{ width: '50%', height: '50%', border: '2px solid rgba(0, 229, 255, 0.2)', borderRadius: '50%' }}></div>
                                <div className="absolute pulse" style={{ width: '35%', height: '35%', border: '2px solid rgba(255, 0, 225, 0.2)', borderRadius: '50%', animationDelay: '1s' }}></div>

                                <div className="z-10 text-center p-4">
                                    <div style={{ fontSize: 'min(2rem, 8vw)', fontWeight: 'bold', marginBottom: '8px' }}>Ready</div>
                                    <div style={{ fontSize: 'min(0.75rem, 3vw)', color: 'var(--accent-cyan)', letterSpacing: '4px', textTransform: 'uppercase' }}>System Online</div>
                                </div>
                            </div>
                        </div>
                    </div>
